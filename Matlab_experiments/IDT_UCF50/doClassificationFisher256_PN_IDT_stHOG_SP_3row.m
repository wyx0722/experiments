...
%     nrCl=3;
%    
%     [idx] = SpatialPyramid_Rows(info.infoTraj, nrCl);
% 
%   
%     
...
%  
%     
%      fisherVT = cell(1,size(idx, 2));
%     
%     %fisherVT{1} = NormalizeRowsUnit(PowerNormalization(mexFisherAssign(desc(:,:), gmmModelName)', 0.14));
%     
%     for c=1:size(idx, 2)
%         
%         fisherVT{c}=NormalizeRowsUnit(PowerNormalization(mexFisherAssign(desc(:,idx(:, c)), gmmModelName)', 0.14));
%      
%     end
%     
%     
