...
n_comb_vladVectors1_1=NormalizeRowsUnit(comb_vladVectors1(:, 1:size(comb_vladVectors1, 2)/4));
allDist{4}=n_comb_vladVectors1_1 * n_comb_vladVectors1_1';
clear n_comb_vladVectors1_1


n_comb_vladVectors2_1=NormalizeRowsUnit(comb_vladVectors2(:, 1:size(comb_vladVectors2, 2)/4));
allDist{5}=n_comb_vladVectors2_1 * n_comb_vladVectors2_1';
clear n_comb_vladVectors2_1

n_comb_vladVectors3_1=NormalizeRowsUnit(comb_vladVectors3(:, 1:size(comb_vladVectors3, 2)/4));
allDist{6}=n_comb_vladVectors3_1 * n_comb_vladVectors3_1';
clear n_comb_vladVectors3_1
