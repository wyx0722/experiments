...
for d=1:length(videoDesc)
    ...
    intraN_vladVectors1=intranormalizationFeatures_L2_PN(vladVectors1, size(vladVectors1, 2)/(clusters*1), 0.3);
    intraN_vladVectors2=intranormalizationFeatures_L2_PN(vladVectors2, size(vladVectors2, 2)/(clusters*2), 0.3);
    intraN_vladVectors3=intranormalizationFeatures_L2_PN(vladVectors3, size(vladVectors3, 2)/(clusters*3), 0.3);
