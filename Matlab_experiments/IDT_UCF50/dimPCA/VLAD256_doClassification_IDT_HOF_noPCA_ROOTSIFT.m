...
saveName = ['/home/ionut/Data/results_desc_IDT/' 'clfsOut/' DescParam2Name(descParam) '__VLAD256_doClassification_IDT_HOF_noPCA_ROOTSIFT__.mat'];
save(saveName, '-v7.3', 'descParam', 'all_clfsOut', 'all_accuracy');

saveName2 = ['/home/ionut/Data/results_desc_IDT/' 'videoRep/' DescParam2Name(descParam) '__VLAD256_doClassification_IDT_HOF_noPCA_ROOTSIFT__.mat'];
