...
mbh_dense=NormalizeRowsUnit(cat(2,mbhx_fisher01, mbhy_fisher01));
allDist{1}=mbh_dense * mbh_dense';
clear mbh_dense


hsm_dense_noSP=NormalizeRowsUnit(cat(2,mbhx_fisher01_noSP, mbhy_fisher01_noSP));
allDist{2}=hsm_dense_noSP * hsm_dense_noSP';
clear hsm_dense_noSP
