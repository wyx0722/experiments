function [ all_clfsOut,  all_accuracy] = evalClassificationPNL2VLAD_doubleCheck( file, alpha, pSize )

[vids, labs, groups] = GetVideosPlusLabels('Full');



pathF='/home/ionut/Data/results/CBMI2015_rezults/videoRep/frameSampleRate/';
load([pathF file]);

pathC='/home/ionut/Data/results/CBMI2015_rezults/clfsOut/frameSampleRate/';
load([pathC file]);
descParam
...
try    
    ...
    fileName=['/home/ionut/experiments/Matlab_experiments/CBMI2016/results/classification_norm_PN/doubleCheckVLAD/results_UCF50_norm__' 'Desc' descType '_norm' descParam.Normalisation 'VLAD.txt'];
