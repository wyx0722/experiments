function [desc, info, descParam] = FEVidHSMDense_nFrames2(video, descParam)
% [desc, info, descParam] = FEVidHSMDense_nFrames2(video, descParam)
%
...
%!!!!compute motion: (F1-F2) + (F2-F3) + (F3-F4) ....
...
[desc, info] = Video2DenseHOGVolumes_SP2(simpleMotion_nF, ...
                                     descParam.BlockSize, ...
                                     descParam.NumBlocks, ...
                                     descParam.NumOr);