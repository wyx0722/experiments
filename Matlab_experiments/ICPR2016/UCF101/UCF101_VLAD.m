function [all_accuracy, all_clfsOut]=UCF101_VLAD(pathFeatures, net, layer, split, nPar)
...
saveName = ['/home/ionut/Data/results/ICPR2016_rezults/' 'clfsOut/'  DescParam2Name(descParam) '_DA-VLAD_.mat'];
save(saveName, '-v7.3', 'descParam', 'all_clfsOut', 'all_accuracy');

saveName2 = ['/home/ionut/Data/results/ICPR2016_rezults/' 'videoRep/' DescParam2Name(descParam) '_DA-VLAD_.mat'];
