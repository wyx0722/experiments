...
temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(maxEncode_split2_spVGG19), ...
                        NormalizeRowsUnit(maxEncode_split2_TempVGG16Split2)) );
allDist{2}=temp * temp';

temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(maxEncode_split3_spVGG19), ...
                        NormalizeRowsUnit(maxEncode_split3_TempVGG16Split3)) );
allDist{3}=temp * temp';
