...
for j=1:nEncoding
    ...
    try    
        ...
        fileName=sprintf('%s%s%s_fisherVector.txt',savePath, descParam.Dataset,descParam.MediaType)
...
saveName = [savePath 'clfsOut/dense/'  DescParam2Name(descParam) 'fisherVector.mat'];
save(saveName, '-v7.3', 'descParam', 'all_clfsOut', 'all_accuracy', 'mean_all_accuracy');

saveName2 = [savePath 'videoRep/dense/' DescParam2Name(descParam) 'fisherVector.mat'];
