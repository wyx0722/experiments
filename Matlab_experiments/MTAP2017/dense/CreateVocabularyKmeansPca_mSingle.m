function [vocab, pcaMap] = CreateVocabularyKmeansPca_mSingle(imNames, descParam, numClusters, pcaDim, ...
...
[labs, ~, vocab] = kmeansj(descriptors, numClusters, 100);
...
save(vocabularySaveName, '-v7.3', 'pcaMap', 'vocab');