...
for dd=1:length(descName)
    ...
    %%%%%%%%%%%
    fileName_sd_f=['FEVid' descName{dd} 'DenseBlockSize8_8_6_FrameSampleRate1MediaTypeVidNormalisationROOTSIFTNumBlocks3_3_2_NumOr8pcaDim72numClusters_256' '_sd_f.mat']
    load(fileName_sd_f);
    ...
    %%%%%%%%%%%
    fileName_b_f=['FEVid' descName{dd} 'DenseBlockSize8_8_6_FrameSampleRate1MediaTypeVidNormalisationROOTSIFTNumBlocks3_3_2_NumOr8pcaDim72numClusters_256' '_b_f.mat']
    load(fileName_b_f);
