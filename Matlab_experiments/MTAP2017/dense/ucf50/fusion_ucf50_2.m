...
load_name=[baze_dir 'FEVidHofDenseBlockSize8_8_3_FrameSampleRate2MediaTypeVidNormalisationROOTSIFTNumBlocks3_3_2_NumOr8numClusters256pcaDim72_SD_VLAD__SD_VLADAll.mat']
load(load_name);
hof_sd_vlad_2=SD_VLADAll;
clear SD_VLADAll

load_name=[baze_dir 'FEVidMBHxDenseBlockSize8_8_3_FrameSampleRate2MediaTypeVidNormalisationROOTSIFTNumBlocks3_3_2_NumOr8numClusters256pcaDim72_SD_VLAD__SD_VLADAll.mat']
load(load_name);
