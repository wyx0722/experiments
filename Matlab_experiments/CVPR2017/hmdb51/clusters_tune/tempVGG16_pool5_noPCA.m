...
t=ST_VLMPF_abs(tDesc, cell_Clusters{1}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); sp32cl64=zeros(length(allPathFeatures), length(t), 'like', t); 
t=ST_VLMPF_abs(tDesc, cell_Clusters{2}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); sp32cl128=zeros(length(allPathFeatures), length(t), 'like', t); 
t=ST_VLMPF_abs(tDesc, cell_Clusters{3}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); sp32cl200=zeros(length(allPathFeatures), length(t), 'like', t); 
t=ST_VLMPF_abs(tDesc, cell_Clusters{4}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); sp32cl256=zeros(length(allPathFeatures), length(t), 'like', t); 
t=ST_VLMPF_abs(tDesc, cell_Clusters{5}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); sp32cl512=zeros(length(allPathFeatures), length(t), 'like', t); 

t=VLAD_1(tDesc, cell_Clusters{1}.vocabulary); v64=zeros(length(allPathFeatures), length(t), 'like', t); 
t=VLAD_1(tDesc, cell_Clusters{2}.vocabulary); v128=zeros(length(allPathFeatures), length(t), 'like', t); 
t=VLAD_1(tDesc, cell_Clusters{3}.vocabulary); v200=zeros(length(allPathFeatures), length(t), 'like', t); 
t=VLAD_1(tDesc, cell_Clusters{4}.vocabulary); v256=zeros(length(allPathFeatures), length(t), 'like', t); 
t=VLAD_1(tDesc, cell_Clusters{5}.vocabulary); v512=zeros(length(allPathFeatures), length(t), 'like', t); 
...
for i=1:length(allPathFeatures)%parfor i=1:length(allPathFeatures)
    ...
    sp32cl64(i, :) = ST_VLMPF_abs(desc, cell_Clusters{1}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary);
    sp32cl128(i, :) = ST_VLMPF_abs(desc, cell_Clusters{2}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary);
    sp32cl200(i, :) = ST_VLMPF_abs(desc, cell_Clusters{3}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary);
    sp32cl256(i, :) = ST_VLMPF_abs(desc, cell_Clusters{4}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary);
    sp32cl512(i, :) = ST_VLMPF_abs(desc, cell_Clusters{5}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary);

    v64 (i, :) = VLAD_1(desc, cell_Clusters{1}.vocabulary);
    v128 (i, :) = VLAD_1(desc, cell_Clusters{2}.vocabulary);
    v200 (i, :) = VLAD_1(desc, cell_Clusters{3}.vocabulary);
    v256 (i, :) = VLAD_1(desc, cell_Clusters{4}.vocabulary);
    v512(i, :) = VLAD_1(desc, cell_Clusters{5}.vocabulary);
