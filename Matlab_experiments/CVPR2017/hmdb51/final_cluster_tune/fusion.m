...
temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(TempSplit1VGG16_sp32cl256), ...
    NormalizeRowsUnit(SpVGG19_sp32cl256), NormalizeRowsUnit(C3D_sp32cl256) ));
allDist{1}=temp * temp';

temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(TempSplit1VGG16_sp64cl256),...
    NormalizeRowsUnit(SpVGG19_sp64cl256), NormalizeRowsUnit(C3D_sp64cl256) ));
allDist{2}=temp * temp';
