...
temp=NormalizeRowsUnit(PowerNormalization(sp2cl256, alpha)); allDist{1}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp4cl256, alpha)); allDist{2}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp8cl256, alpha)); allDist{3}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp16cl256, alpha)); allDist{4}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp32cl256, alpha)); allDist{5}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp64cl256, alpha)); allDist{6}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp128cl256, alpha)); allDist{7}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp256cl256, alpha)); allDist{8}=temp * temp';

temp=NormalizeRowsUnit(PowerNormalization(sp32cl64, alpha)); allDist{9}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp32cl128, alpha)); allDist{10}=temp * temp';
temp=NormalizeRowsUnit(PowerNormalization(sp32cl512, alpha)); allDist{11}=temp * temp';

temp=NormalizeRowsUnit(PowerNormalization(vlad256, alpha)); allDist{12}=temp * temp';

temp=NormalizeRowsUnit(PowerNormalization(sp32cl256(:, 1:size(cell_Clusters{3}.vocabulary,1)*size(cell_Clusters{3}.vocabulary,2)), alpha));
...
for j=1:nEncoding
 ...
 bazeSavePath='/home/ionut/asustor_ionut/Data/results/cvpr2017/hmdb51/clusters/';
