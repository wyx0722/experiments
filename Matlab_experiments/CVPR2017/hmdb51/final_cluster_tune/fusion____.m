...
t1=TempSplit1VGG16_sp64cl256;
t1(:, end-(64*256) + 1 :end)=PowerNormalization(t1(:, end-(64*256) + 1 : end), 0.5);

t2=SpVGG19_sp64cl256;
t2(:, end-(64*256) + 1 :end)=PowerNormalization(t2(:, end-(64*256) + 1 : end), 0.5);

t3=C3D_sp64cl256;
t3(:, end-(64*256) + 1 :end)=PowerNormalization(t3(:, end-(64*256) + 1 : end), 0.5);
