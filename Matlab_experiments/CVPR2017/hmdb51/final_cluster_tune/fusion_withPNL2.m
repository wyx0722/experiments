...
name=[bazeDir 'FEVid_deepFeaturesClusters64_128_256_512_DatasetHMDB51Layerconv5bMediaTypeDeepFNormFeatureMapsNoneNormalisationNonenetC3DpcaDim0spClusters2_4_8_16_32_64_128_256___sp64cl256.mat']
load(name);
C3D_sp64cl256=sp64cl256;

name=[bazeDir 'FEVid_deepFeaturesClusters64_128_256_512_DatasetHMDB51Layerpool5MediaTypeDeepFNormFeatureMapsNoneNormalisationNonenetSpVGG19pcaDim0spClusters2_4_8_16_32_64_128_256___sp64cl256.mat']
load(name);
SpVGG19_sp64cl256=sp64cl256;

name=[bazeDir 'FEVid_deepFeaturesClusters64_128_256_512_DatasetHMDB51Layerpool5MediaTypeDeepFNormFeatureMapsNoneNormalisationNonenetTempSplit1VGG16pcaDim0spClusters2_4_8_16_32_64_128_256___sp64cl256.mat']
load(name);
TempSplit1VGG16_sp64cl256=sp64cl256;
...
temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(PowerNormalization(TempSplit1VGG16_sp32cl256, alpha)), ...
    NormalizeRowsUnit(PowerNormalization(SpVGG19_sp32cl256, alpha)), NormalizeRowsUnit(PowerNormalization(C3D_sp32cl256, alpha)) ));
allDist{1}=temp * temp';

temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(PowerNormalization(TempSplit1VGG16_sp64cl256, alpha)),...
    NormalizeRowsUnit(PowerNormalization(SpVGG19_sp64cl256, alpha)), NormalizeRowsUnit(PowerNormalization(C3D_sp64cl256, alpha)) ));
allDist{2}=temp * temp';
