...
for i=1:length(randVideos)
    ...
    tic; max_pooling_abs(desc, cell_Clusters{1}.vocabulary); t_cl64(i)=toc;
    tic; max_pooling_abs(desc, cell_Clusters{2}.vocabulary); t_cl128(i)=toc;
    tic; max_pooling_abs(desc, cell_Clusters{3}.vocabulary); t_cl200(i)=toc;
    tic; max_pooling_abs(desc, cell_Clusters{4}.vocabulary); t_cl256(i)=toc;
    tic; max_pooling_abs(desc, cell_Clusters{5}.vocabulary); t_cl512(i)=toc;
