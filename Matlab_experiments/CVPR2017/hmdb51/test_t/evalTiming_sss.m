...
for i=1:length(randVideos)
    ...
    tic; sss(desc, cell_Clusters{1}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); t_sp32cl64(i)=toc;
    tic; sss(desc, cell_Clusters{2}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); t_sp32cl128(i)=toc;
    tic; sss(desc, cell_Clusters{3}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); t_sp32cl200(i)=toc;
    tic; sss(desc, cell_Clusters{4}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); t_sp32cl256(i)=toc;
    tic; sss(desc, cell_Clusters{5}.vocabulary, info.spInfo, cell_spClusters{6}.vocabulary); t_sp32cl512(i)=toc;
