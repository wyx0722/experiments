...
addpath([basedir 'Toolboxes/prtools']); %addpath([basedir 'Toolboxes/prtools4.2.5/prtools']); %addpath([basedir 'Toolboxes/prtools4.1.3']);
...
addpath('/home/ionut/experiments/Matlab_experiments/usefulAddPath/')
