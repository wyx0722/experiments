...
temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(PowerNormalization(intraL2_vladNoMean, alpha)), NormalizeRowsUnit(PowerNormalization(intraL2_stdDiff, alpha)) ) );
allDist{1}=temp * temp';

temp=NormalizeRowsUnit(PowerNormalization( cat(2, NormalizeRowsUnit(PowerNormalization(intraL2_vladNoMean, alpha)), NormalizeRowsUnit(PowerNormalization(intraL2_stdDiff, alpha)) ), alpha) );
allDist{2}=temp * temp';



temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(PowerNormalization(intraL2_vladMean, alpha)), NormalizeRowsUnit(PowerNormalization(intraL2_stdDiffMean, alpha)) ) );
allDist{3}=temp * temp';

temp=NormalizeRowsUnit(PowerNormalization( cat(2, NormalizeRowsUnit(PowerNormalization(intraL2_vladMean, alpha)), NormalizeRowsUnit(PowerNormalization(intraL2_stdDiffMean, alpha)) ), alpha) );
allDist{4}=temp * temp';
