...
temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(PowerNormalization(vladNoMean, alpha)), NormalizeRowsUnit(PowerNormalization(stdDiff, alpha)) ) );
allDist{1}=temp * temp';

temp=NormalizeRowsUnit(PowerNormalization( cat(2, NormalizeRowsUnit(PowerNormalization(vladNoMean, alpha)), NormalizeRowsUnit(PowerNormalization(stdDiff, alpha)) ), alpha) );
allDist{2}=temp * temp';



temp=NormalizeRowsUnit( cat(2, NormalizeRowsUnit(PowerNormalization(vladMean, alpha)), NormalizeRowsUnit(PowerNormalization(stdDiffMean, alpha)) ) );
allDist{3}=temp * temp';

temp=NormalizeRowsUnit(PowerNormalization( cat(2, NormalizeRowsUnit(PowerNormalization(vladMean, alpha)), NormalizeRowsUnit(PowerNormalization(stdDiffMean, alpha)) ), alpha) );
allDist{4}=temp * temp';
