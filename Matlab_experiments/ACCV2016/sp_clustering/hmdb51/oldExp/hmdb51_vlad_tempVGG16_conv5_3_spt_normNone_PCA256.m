...
bazePathFeatures='/home/ionut/asustor_ionut/Data/hmdb51_action_temporal_vgg_16_split1_features_opticalFlow_tvL1/Videos/'
descParam
...
t=VLAD_1_mean_spClustering(tDesc, cell_Clusters{1}.vocabulary, info.spInfo, cell_spClusters{2}.vocabulary);
spV32=zeros(length(trainTestSetPathFeatures), length(t), 'like', t);

t=VLAD_1_mean_spClustering(tDesc, cell_Clusters{1}.vocabulary, info.spInfo, cell_spClusters{3}.vocabulary);
spV64=zeros(length(trainTestSetPathFeatures), length(t), 'like', t);

t=VLAD_1_mean_spClustering(tDesc, cell_Clusters{1}.vocabulary, info.spInfo, cell_spClusters{4}.vocabulary);
...
parfor i=1:length(trainTestSetPathFeatures)
    ...
    spV64(i, :) = VLAD_1_mean_spClustering(desc, cell_Clusters{1}.vocabulary, info.spInfo, cell_spClusters{3}.vocabulary);
    spV256(i, :) = VLAD_1_mean_spClustering(desc, cell_Clusters{1}.vocabulary, info.spInfo, cell_spClusters{4}.vocabulary);
