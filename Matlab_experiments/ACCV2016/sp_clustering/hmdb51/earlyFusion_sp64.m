...
hof_norm_spV64 = NormalizeRowsUnit(PowerNormalization(spV64, alpha_handF));
...
hog_norm_spV64 = NormalizeRowsUnit(PowerNormalization(spV64, alpha_handF));
...
mbhx_norm_spV64 = NormalizeRowsUnit(PowerNormalization(spV64, alpha_handF));
...
mbhy_norm_spV64 = NormalizeRowsUnit(PowerNormalization(spV64, alpha_handF));
...
spVGG19_norm_spV64 = NormalizeRowsUnit(PowerNormalization(spV64, alpha_deepF));
...
tempVGG16_norm_spV64 = NormalizeRowsUnit(PowerNormalization(spV64, alpha_deepF));
...
temp=NormalizeRowsUnit(cat(2,hof_norm_spV64, hog_norm_spV64, mbhx_norm_spV64, mbhy_norm_spV64));
allDist{1}=temp * temp';




temp=NormalizeRowsUnit(cat(2,spVGG19_norm_spV64, tempVGG16_norm_spV64));
allDist{2}=temp * temp';


temp=NormalizeRowsUnit(cat(2,spVGG19_norm_spV64, tempVGG16_norm_spV64,hof_norm_spV64, hog_norm_spV64, mbhx_norm_spV64, mbhy_norm_spV64));
allDist{3}=temp * temp';
