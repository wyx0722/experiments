function [cell_Clusters, cell_spClusters, pcaMap] = CreateVocabularyDefaultKmeansPca_sptCl(imNames, descParam, ...
...
for i=1: size(descParam.Clusters, 2)
    ...
    [labs, vocab] = kmeans(descriptors, descParam.Clusters(i));
...
for i=1: size(descParam.spClusters, 2)
    ...
    [labs, vocab] = kmeans(sptInfo, descParam.spClusters(i));
