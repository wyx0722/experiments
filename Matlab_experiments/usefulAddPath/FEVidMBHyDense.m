function [desc, info, descParam] = FEVidMBHyDense(video, descParam, flowMethod)
% [desc, info] = FEVidHogDense(video, descParam)
%
% Wrapper to densely sample MBH (for vertical direction) features from a
% video (optical flow of vertical component) using the fast 
