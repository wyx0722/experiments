...
if not os.path.isfile(caffe_root + 'models/action_recognition/cuhk_action_spatial_vgg_16_split1.caffemodel'):
...
net = caffe.Net(caffe_root + 'models/action_recognition/cuhk_action_spatial_vgg_16_deploy.prototxt',
                caffe_root + 'models/action_recognition/cuhk_action_spatial_vgg_16_split1.caffemodel',
                caffe.TEST)
...
#load the mean
mat = scipy.io.loadmat('/home/ionut/caffe/models/action_recognition/rgb_mean.mat')
m_rgb=mat['image_mean']
reshape_m_rgb=m_rgb.reshape(1,3,224,224)
reshape_m_rgb[0, 0, :, :]=m_rgb[:, :, 0]
reshape_m_rgb[0, 1, :, :]=m_rgb[:, :, 1]
reshape_m_rgb[0, 2, :, :]=m_rgb[:, :, 2]
...
rootPathSave='/home/ionut/Data/hmdb51_action_spatial_vgg_16_split1_features_rawFrames/Videos/' #the root path to save the features
...
for video in range(3383,len(videoList)):
    print 'Features extraction for video (range(3383,len(videoList)))', video+1, ': ', videoList[video] 
    ...
    for file in os.listdir(rootRawFrames + videoList[video] + '/frames/'):
          if file.endswith(".jpg"):
                ...
                net.blobs['data'].data[...] = net.blobs['data'].data[...] - reshape_m_rgb #substract the mean
