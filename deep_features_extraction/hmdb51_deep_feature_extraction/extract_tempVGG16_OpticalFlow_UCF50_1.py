...
rootPathSave='/home/ionut/Data/action_temporal_vgg_16_split1_features_opticalFlow_tvL1_UCF50/Videos/' #the root path to save the features
    		...
    		if file.endswith(".jpg"):
          		if nFrames<stackFrames:
					...
					#extract conv4_3 features from the network and save them in a .txt file
	                		feat_conv4_3 = net.blobs['conv4_3'].data[0]
	                		feat_conv4_3.tofile(file_conv4_3, sep=" ", format="%s")
	                		file_conv4_3.write('\n')
