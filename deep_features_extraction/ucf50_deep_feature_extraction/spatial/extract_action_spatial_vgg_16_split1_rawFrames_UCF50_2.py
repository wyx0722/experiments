...
rootPathSave='/home/ionut/Data/spatial_vgg_16_split1_rawFrames_UCF50/Videos/' #the root path to save the features
...
for video in range(3310,len(videoList)):
    print 'Features extraction for video (range(3310,len(videoList)))', video+1, ': ', videoList[video] 
