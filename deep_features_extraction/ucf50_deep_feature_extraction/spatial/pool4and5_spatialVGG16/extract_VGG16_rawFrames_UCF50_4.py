...
if not os.path.isfile(caffe_root + 'models/VGG_ILSVRC_16/VGG_ILSVRC_16_layers.caffemodel'):
...
net = caffe.Net(caffe_root + 'models/VGG_ILSVRC_16/VGG_ILSVRC_16_layers_deploy.prototxt',
                caffe_root + 'models/VGG_ILSVRC_16/VGG_ILSVRC_16_layers.caffemodel',
                caffe.TEST)
...
rootPathSave='/home/ionut/asustor_ionut_2/ionut/Data/VGG_16_v-features_rawFrames_UCF50/Videos/' #the root path to save the features
