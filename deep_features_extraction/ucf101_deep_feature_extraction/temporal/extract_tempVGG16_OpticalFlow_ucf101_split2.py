...
import os
if not os.path.isfile(caffe_root + 'models/action_recognition/cuhk_action_temporal_vgg_16_split2.caffemodel'):
...
net = caffe.Net(caffe_root + 'models/action_recognition/cuhk_action_temporal_vgg_16_flow_deploy.prototxt',
                caffe_root + 'models/action_recognition/cuhk_action_temporal_vgg_16_split2.caffemodel',
                caffe.TEST)
...
rootPathSave='/home/ionut/asustor_ionut_2/ionut/Data/ucf101_action_temporal_vgg_16_split123_features_opticalFlow_tvL1/split2/Videos/' #the root path to save the features
...
for video in range(380,len(videoList)):
	print ' <Split2> Features extraction for video (range(0,len(videoList)))', video+1,':  ', videoList[video]
