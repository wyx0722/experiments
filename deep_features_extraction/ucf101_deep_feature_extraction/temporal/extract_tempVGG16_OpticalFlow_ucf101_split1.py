...
rootPathSave='/home/ionut/asustor_ionut_2/ionut/Data/ucf101_action_temporal_vgg_16_split123_features_opticalFlow_tvL1/split1/Videos/' #the root path to save the features
...
for video in range(414,len(videoList)):
	print ' <Split1> Features extraction for video (range(0,len(videoList)))', video+1,':  ', videoList[video]
