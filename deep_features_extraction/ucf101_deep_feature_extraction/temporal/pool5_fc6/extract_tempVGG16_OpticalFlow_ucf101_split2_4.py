...
rootPathSave='/home/ionut/Data/ucf101_action_temporal_vgg_16_split123_features_pool5_fc6_opticalFlow_tvL1/split2/Videos/' #the root path to save the features
...
for video in range(9990,len(videoList)):
	print ' <Split2> Features extraction for video (range(9990,len(videoList)))', video+1,':  ', videoList[video]
