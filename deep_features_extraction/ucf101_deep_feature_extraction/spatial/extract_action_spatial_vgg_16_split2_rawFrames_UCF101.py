...
if not os.path.isfile(caffe_root + 'models/action_recognition/cuhk_action_spatial_vgg_16_split2.caffemodel'):
...
net = caffe.Net(caffe_root + 'models/action_recognition/cuhk_action_spatial_vgg_16_deploy.prototxt',
                caffe_root + 'models/action_recognition/cuhk_action_spatial_vgg_16_split2.caffemodel',
                caffe.TEST)
...
rootPathSave='/home/ionut/asustor_ionut_2/ionut/Data/ucf101_action_spatial_vgg_16_split123_features_rawFrames/split2/Videos/' #the root path to save the features
